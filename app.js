function fetch_data(){
    ...
    var sharehigh = []
    var sharelow = []
    const url ='https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=TSLA&interval=5min&apikey=58W29C8QE0JQWCXQ'
    fetch(url)
    ...
    .then (data => {
        ...
        document.getElementById('share_max').innerHTML = `<h3> Maximum Price: `+max_price+`$<\h3>` 
        document.getElementById('share_min').innerHTML = `<h3> Maximum Price: `+min_price+`$ <\h3>`
